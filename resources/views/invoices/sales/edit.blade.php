                ...
                <div class="row">
                  <div class="form-group col-md-6">
                    ...
                    <div class="form-group">
                      ...
                      <br>
                      {!! Form::select('client_code', $clients->pluck('party_id', 'id'), $sales->client_id, ['class'=>'form-control select2', 'id'=>'clientCode', 'onchange'=>'checkClientCode(this)']) !!}
                    </div>         
                  ...
                  <div class="col-md-6">
                    ...
                    <div class="form-group">
                      ...
                      <br>
                      {!! Form::select('client_name', $clients->pluck('party_name', 'id'), $sales->client_id, ['class'=>'form-control select2', 'id'=>'clientName', 'onchange'=>'checkClientName(this)']) !!}
                  ...
                  <div class="col-md-6">
                    ...
                    <div class="form-group">
                      ...
                      {!! Form::text('price_per_unit[]', $sales_product->price_per_unit, ['class'=>'form-control', "id"=>"productPrice-$x", "required"]) !!}
                    </div>
                    <div class="form-group">
                  ...
                  <div class="col-md-6">
                    ...
                    <div class="form-group">
                      ...
                      {!! Form::text('quantity[]', $sales_product->quantity, ['class'=>'form-control', "id"=>"quantity-$x"]) !!}
                    </div>
                    <div class="form-group">
