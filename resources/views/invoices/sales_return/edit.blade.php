  ...
  <div class="row">
    <div class="col-md-10 col-offset-1">
      <div class="panel panel-default">
        <div class="panel-heading"><h3>Edit Sales Return</h3></div>
        <hr>

        <div class="panel-body">
          {!! Form::model($sales_returns, array('route'=>['sales_return.update', $sales_returns->id], 'method'=>'PUT')) !!}
                ...
                <div class="row">
                  <div class="form-group col-md-6">
                    ...
                    <div class="form-group">
                      ...
                      <br>
                      {!! Form::select('client_code', $clients->pluck('party_id', 'id'), $sales_returns->client_id, ['class'=>'form-control select2', 'id'=>'clientCode', 'onchange'=>'checkClientCode(this)']) !!}
                    </div>         
                  ...
                  <div class="col-md-6">
                    ...
                    <div class="form-group">
                      ...
                      <br>
                      {!! Form::select('client_name', $clients->pluck('party_name', 'id'), $sales_returns->client_id, ['class'=>'form-control select2', 'id'=>'clientName', 'onchange'=>'checkClientName(this)']) !!}

                      {!! Form::hidden('client_id', $sales_returns->client_id, ['id'=>'clientID']) !!}
                    </div>
                  </div>

                  @foreach($sales_returns_products as $sales_returns_product)
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      {!! Form::select('product_code[]', $products->pluck('product_code', 'id'), $product->id, ['class'=>'form-control select2', "id"=>"productid-$x", "onchange"=>"check(this, $x)"]) !!}
                    </div>
                    <div class="form-group">
                      {!! Form::label('product_type', 'Product Type:') !!}
                      {!! Form::text('product_type[]', $product_type->type, ['class'=>'form-control', "id"=>"productType-$x"]) !!}
                      {{ Form::hidden('invisible', $product_type->id, ["id"=>"productTypeId-$x"]) }}
                    </div>
                    <div class="form-group">
                      {!! Form::label('price_per_unit', 'Price/Unit:') !!}
                      {!! Form::text('price_per_unit[]', $sales_returns_product->price_per_unit, ['class'=>'form-control', "id"=>"productPrice-$x", "required"]) !!}
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                      ...
                      {!! Form::text('bill_after_commission[]', null, ['class'=>'form-control readonly', "id"=>"billAfterCommission-$x", 'required']) !!}
                    </div>
                  </div>
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      {!! Form::select('product_name[]', $products->pluck('product_name', 'id'), $product->id, ['class'=>'form-control select2', "id"=>"productName-$x", "onchange"=>"check2(this, $x)"]) !!}
                    </div>
                    <div class="form-group">
                      {!! Form::label('brand', 'Brand:') !!}
                      {!! Form::text('brand[]', $product->brand, ['class'=>'form-control', "id"=>"productBrand-$x"]) !!}
                    </div>
                    <div class="form-group">
                      {!! Form::label('quantity', 'Quantity:') !!}
                      {!! Form::text('quantity[]', $sales_returns_product->quantity, ['class'=>'form-control', "id"=>"quantity-$x"]) !!}
                    </div>
                    <div class="form-group">
                  ...
                  <div class="col-md-12">
                    <div class="form-group">
                      ...
                      {!! Form::text('remark[]', $sales_returns_product->remark, ['class'=>'form-control']) !!}
                    </div>
                    <br>
                  ...
                  <div class="container-fluid"">
                    ...
                    <div class="form-group">
                      {!! Form::label('remark', 'Remark:') !!}
                      {!! Form::textarea('remark', null, ['class'=>'form-control', 'size'=>'30x3']) !!}
                    </div>
      ...
      @foreach($sales_returns->clients as $client)
